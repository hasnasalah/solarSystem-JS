...
solarSystem[2].diameter="7926.38 mi"
...
let nepSa=Number(system.neptune.satellites);
let jupSa=Number(system.jupiter.satellites);
let uraSa=Number(system.uranus.satellites);
let satSa=Number(system.saturn.satellites);
console.log(nepSa+jupSa+uraSa+satSa);
...
let jupyterMomentum=system.jupiter.mass*system.jupiter.velocity
let plotoMomentum=system.pluto.mass*system.pluto.velocity
console.log(jupyterMomentum-plotoMomentum)